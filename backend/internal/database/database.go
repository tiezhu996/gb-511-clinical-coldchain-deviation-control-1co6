...
func seedTemperatureWindow(ctx context.Context, db *gorm.DB) error {
	...
	items := []model.TemperatureWindow{
		...
		{BaseModel: model.BaseModel{Code: "TW-004", Name: "在途临床样本 2-8C 收紧版", Status: "draft", Version: 1, Description: "同产品类别同场站收紧草案，生效前需核验在途影响"}, ProductClass: "临床样本", MinimumCelsius: 2, MaximumCelsius: 8, MaxExcursionMinutes: 10, QualityOwner: "reviewer", Facility: "沪杭运输线", Owner: "reviewer", Category: "临床样本", RiskLevel: "high", MetricValue: 8, MetricUnit: "C", EffectiveAt: now.Add(24 * time.Hour), Evidence: "DRAFT-SOP-CC-02 v5", RelatedCode: "SOP-CC-02"},
		{BaseModel: model.BaseModel{Code: "TW-005", Name: "沪杭线临床样本 2-8C 现用版", Status: "active", Version: 2, Description: "沪杭运输线当前生效规则，TW-004 生效后转为被替代"}, ProductClass: "临床样本", MinimumCelsius: 2, MaximumCelsius: 8, MaxExcursionMinutes: 15, QualityOwner: "reviewer", Facility: "沪杭运输线", Owner: "reviewer", Category: "临床样本", RiskLevel: "high", MetricValue: 8, MetricUnit: "C", EffectiveAt: now.Add(-7 * 24 * time.Hour), Evidence: "SOP-CC-02 v4", RelatedCode: "SOP-CC-02"},
	}
	return db.WithContext(ctx).Create(&items).Error
}
